...
import { gray, teal, red, black, white, pink } from './colors';

export const COLOR_BASE_PRIMARY_DARK = teal.teal_70;
export const COLOR_BASE_PRIMARY_MAIN = '#FF4057';
export const COLOR_BASE_PRIMARY_LIGHT = teal.teal_30;
export const COLOR_BASE_PRIMARY_RED = red.red_custom;

export const COLOR_BASE_PINK_DARK = '#CB1B30';
export const COLOR_BASE_PINK_LIGHT = pink.pink_10;

export const COLOR_BASE_BACKGROUND = gray.gray_110;
export const COLOR_BASE_SUBTITLE = gray.gray_120;
...
export const COLOR_BASE_RED = red.red_101;
export const COLOR_BASE_PINK = red.red_102;
...
export const COLOR_ONBOARDING_HEADER = '#FF4057';
export const COLOR_ONBOARDING_TEXT = '#5A5773';
...
export const COLOR_PINK = '#FF4057';
...
const FONT_PRIMARY_MEDIUM = 'Montserrat-Medium';
const FONT_PRIMARY_LIGHT = 'Montserrat-Light';
...
const FONT_SECONDARY_CUSTOM = 'NHaasGroteskTXPro-Regular';
...
const FONT_SIZE_BALANCE = 28;
const FONT_SIZE_GREET = 15;
...
export const FONT_BALANCE_PRIMARY = {
  fontFamily: FONT_SECONDARY_CUSTOM,
  fontSize: FONT_SIZE_BALANCE
};

export const FONT_CATEGORY_PRIMARY = {
  fontFamily: FONT_PRIMARY_REGULAR,
  fontSize: FONT_SIZE_BALANCE
};

export const FONT_CATEGORY_SECONDARY = {
  fontFamily: FONT_PRIMARY_REGULAR,
  fontSize: FONT_SIZE_GREET
};
